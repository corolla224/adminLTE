...
<section id="layout">
  ...
  <div class="callout callout-danger lead">
    <h4>Tip!</h4>
    <p>The <a href="../starter">starter page</a> is a good place to start building your app if you'd like to start from scratch.</p>
  </div>
...
&LT;header class="main-header">
  &LT;nav class="navbar navbar-static-top">
    ...
    &LT;div class="navbar-header">
      &LT;a href="../../index2" class="navbar-brand">&LT;b>Admin&LT;/b>LTE&LT;/a>
  ...
  <div class="row bring-up">
    ...
    <div class="col-sm-3">
      <ul class="list-unstyled">
        ...
        <li><a href="http://ionden.com/a/plugins/ion.rangeSlider/en" target="_blank">Ion Slider</a></li>
    ...
    <div class="col-sm-3">
      <ul class="list-unstyled">
        <li><h4>Other</h4></li>
        <li><a href="https://datatables.net/examples/styling/bootstrap" target="_blank">DataTables</a></li>
